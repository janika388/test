...
function osztas(){ 
  var szam1 = Math.floor(Math.random() * 100) + 1,
      szam2 = Math.floor(Math.random() * 10)+1,
  ...
  if(szam1 > szam2){
    ...
    helyesValasz= eval(szam2 / szam1);
    document.getElementById("szam1").innerHTML = szam2; 
    document.getElementById("szam2").innerHTML = szam1;
